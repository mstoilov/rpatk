...
//	rpa_compiler_rulepref_set_ruleuid_flags_s(co, "regexchar", RPA_PRODUCTION_REGEXCHAR);
...
//	rpa_compiler_rulepref_set_ruleuid_flags_s(co, "escapedchar", RPA_PRODUCTION_ESCAPEDCHAR);
