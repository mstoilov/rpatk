...
int usage(int argc, const char *argv[])
{
		...
		fprintf(stderr, "\t-s \"string\"              Parse or match the content in the string.\n");
		fprintf(stderr, "\t-i                       Ignore case.\n");
		fprintf(stderr, "\t-m                       Match.\n");
		fprintf(stderr, "\t-p                       Parse. Display parse info.\n");
		fprintf(stderr, "\t-a                       Parse. Display parse records.\n");
		...
		fprintf(stderr, "\t-d rule                  Dump production rule in a tree format.\n");
...
int main(int argc, const char *argv[])
{
	...
	for (i = 0; i < (int)r_array_length(buffers); i++) {
