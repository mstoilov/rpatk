...
typedef void (*r_array_destroyelt_fun)(rpointer pval);
typedef void (*r_array_copyelt_fun)(rpointer pdst, rconstpointer psrc, ruint elt_size);
...
struct rarray_s {
	...
	ruint alloc_len;
	ruint elt_size;
	r_array_destroyelt_fun destroy;
	r_array_copyelt_fun copy;
};
