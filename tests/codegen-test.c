...
//	rvm_asmins_t *code;
	...
	rvm_asm_dump(rvm_codegen_getcode(cg), rvm_codegen_getcodesize(cg));

	rvm_cpu_exec_debug(cpu, rvm_codegen_getcode(cg), 0);
	rvm_cpu_destroy(cpu);
