...
static void rjs_op_cast(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_binary_handler(cpu->opmap, RVM_OPID_CAST, cpu, RVM_CPUREG_PTR(cpu, ins->op1), RVM_CPUREG_PTR(cpu, ins->op2), &tmp);
}
...
static void rjs_op_eadd(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_binary_handler(cpu->opmap, RVM_OPID_ADD, cpu, RVM_CPUREG_PTR(cpu, ins->op1), arg2, arg3);
}
...
static void rjs_op_esub(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_binary_handler(cpu->opmap, RVM_OPID_SUB, cpu, RVM_CPUREG_PTR(cpu, ins->op1), arg2, arg3);
}
...
static void rjs_op_eneg(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_binary_handler(cpu->opmap, RVM_OPID_SUB, cpu, RVM_CPUREG_PTR(cpu, ins->op1), &zero, arg2);
}
...
static void rjs_op_emul(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_binary_handler(cpu->opmap, RVM_OPID_MUL, cpu, RVM_CPUREG_PTR(cpu, ins->op1), arg2, arg3);
}
...
static void rjs_op_ediv(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_binary_handler(cpu->opmap, RVM_OPID_DIV, cpu, RVM_CPUREG_PTR(cpu, ins->op1), arg2, arg3);
}
...
static void rjs_op_emod(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_binary_handler(cpu->opmap, RVM_OPID_MOD, cpu, RVM_CPUREG_PTR(cpu, ins->op1), arg2, arg3);
}
...
static void rjs_op_elsl(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_binary_handler(cpu->opmap, RVM_OPID_LSL, cpu, RVM_CPUREG_PTR(cpu, ins->op1), arg2, arg3);
}
...
static void rjs_op_elsr(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_binary_handler(cpu->opmap, RVM_OPID_LSR, cpu, RVM_CPUREG_PTR(cpu, ins->op1), arg2, arg3);
}
...
static void rjs_op_elsru(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_binary_handler(cpu->opmap, RVM_OPID_LSRU, cpu, RVM_CPUREG_PTR(cpu, ins->op1), arg2, arg3);
}
...
static void rjs_op_eand(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_binary_handler(cpu->opmap, RVM_OPID_AND, cpu, RVM_CPUREG_PTR(cpu, ins->op1), arg2, arg3);
}
...
static void rjs_op_eorr(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_binary_handler(cpu->opmap, RVM_OPID_OR, cpu, RVM_CPUREG_PTR(cpu, ins->op1), arg2, arg3);
}
...
static void rjs_op_exor(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_binary_handler(cpu->opmap, RVM_OPID_XOR, cpu, RVM_CPUREG_PTR(cpu, ins->op1), arg2, arg3);
}
...
static void rjs_op_enot(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_unary_handler(cpu->opmap, RVM_OPID_NOT, cpu, RVM_CPUREG_PTR(cpu, ins->op1), arg2);
}
...
static void rjs_op_eland(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_binary_handler(cpu->opmap, RVM_OPID_LOGICAND, cpu, RVM_CPUREG_PTR(cpu, ins->op1), arg2, arg3);
}
...
static void rjs_op_elor(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_binary_handler(cpu->opmap, RVM_OPID_LOGICOR, cpu, RVM_CPUREG_PTR(cpu, ins->op1), arg2, arg3);
}
...
static void rjs_op_elnot(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_unary_handler(cpu->opmap, RVM_OPID_LOGICNOT, cpu, RVM_CPUREG_PTR(cpu, ins->op1), arg2);
}
...
static void rjs_op_eeq(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_binary_handler(cpu->opmap, RVM_OPID_EQ, cpu, RVM_CPUREG_PTR(cpu, ins->op1), arg2, arg3);
}
...
static void rjs_op_enoteq(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_binary_handler(cpu->opmap, RVM_OPID_NOTEQ, cpu, RVM_CPUREG_PTR(cpu, ins->op1), arg2, arg3);
}
...
static void rjs_op_egreat(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_binary_handler(cpu->opmap, RVM_OPID_GREATER, cpu, RVM_CPUREG_PTR(cpu, ins->op1), arg2, arg3);
}
...
static void rjs_op_egreateq(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_binary_handler(cpu->opmap, RVM_OPID_GREATEREQ, cpu, RVM_CPUREG_PTR(cpu, ins->op1), arg2, arg3);
}
...
static void rjs_op_elesseq(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_binary_handler(cpu->opmap, RVM_OPID_LESSEQ, cpu, RVM_CPUREG_PTR(cpu, ins->op1), arg2, arg3);
}
...
static void rjs_op_eless(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_binary_handler(cpu->opmap, RVM_OPID_LESS, cpu, RVM_CPUREG_PTR(cpu, ins->op1), arg2, arg3);
}
...
static void rjs_op_ecmp(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_binary_handler(cpu->opmap, RVM_OPID_CMP, cpu, NULL, arg1, arg2);
}
...
static void rjs_op_ecmn(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_binary_handler(cpu->opmap, RVM_OPID_CMN, cpu, NULL, arg1, arg2);
}
...
static void rjs_op_propstr(rvmcpu_t *cpu, rvm_asmins_t *ins)
{
	...
	rjs_opmap_invoke_binary_handler(cpu->opmap, RVM_OPID_CAST, cpu, &tmp, RVM_CPUREG_PTR(cpu, ins->op3), &tmp);
...
rjs_engine_t *rjs_engine_create()
{
	...
	cpu->opmap = rjs_opmap_create();
	rjs_op_binary_init(cpu->opmap);
	rjs_op_cast_init(cpu->opmap);
	rjs_op_not_init(cpu->opmap);
	rjs_op_logicnot_init(cpu->opmap);
...
void rjs_engine_destroy(rjs_engine_t *jse)
{
	...
	if (jse) {
		...
		rjs_opmap_destroy(jse->cpu->opmap);
